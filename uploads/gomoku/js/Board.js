...
var Board = function(boardElm, backgroundElm){
    ...
    (function(){
        for (var i=0;i<2;i++){ var="" tmp="[];" for(var="" j="0;j<4;j++){" tmpp="[];" k="0;k<15;k++){" tmpr="[];" l="0;l<15;l++){" tmpr.push(1);="" }="" tmpp.push(tmpr);="" tmp.push(tmpp);="" map.push(tmp);="" })();="" this.setclickable="function(yes," color){="" clickable="yes;" if(yes){="" boardelm.addclass("playing");="" }else{="" boardelm.removeclass("playing");="" if(color){="" boardelm.removeclass("black").removeclass("white").addclass(color);="" };="" this.setgo="function(r," c,="" places[r][c].set(color);="" setnum++;="" this.unsetgo="function(r," c){="" places[r][c].unset();="" this.updatemap(r,="" c);="" setnum--;="" this.highlight="function(r,c){" this.unhighlight();="" places[r][c].highlight();="" this.unhighlight="function(){" $(".last-move").removeclass("last-move");="" this.winchange="function(r," boardelm.find(".warning").removeclass("warning");="" num="colorToNum[color]," dir;="" i="0;" <="" 4;="" i++){="" if(map[num][i][r][c]="">= 5){
                dir = i;
                break;
            }
        }
